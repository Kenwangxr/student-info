...
<div class="container">
				...
				<c:forEach var="courseplan" items="${sessionScope.coursePlanList}"
					...
					<tr>
						...
						<td><a class="btn btn-default"
							href="/CoursePlanHandler/modicouplan/${courseplan.courseclass}">
								修改 </a></td>
						<td><a class="btn btn-default"
							href="/CoursePlanHandler/delcouplan/${courseplan.courseclass}/${tid}">
								删除 </a></td>
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<ul class="pagination">
				<li><a href="/TeacherHandler/managecou/${sessionScope.tid }/1">首页</a></li>
				<c:if test="${pageInfo.hasPreviousPage }">
					<li><a href="/TeacherHandler/managecou/${sessionScope.tid }/${pageInfo.pageNum-1}"
				...
				<c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
					...
					<c:if test="${page_Num != pageInfo.pageNum }">
						<li><a href="/TeacherHandler/managecou/${sessionScope.tid }/${page_Num }">${page_Num }</a></li>
					</c:if>
				...
				<li><a href="/TeacherHandler/managecou/${sessionScope.tid }/${pageInfo.pages}">末页</a></li>
			</ul>
			</nav>
		</div>
	</div>
