...
<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="alert alert-warning" role="alert"><h5>课程名</h5><p>${cname}</p> 该课程暂无教师代理，是否选课等待？注意：选课之后再教师代理之前无法查看选课结果，但是可以退选</div>
			</div>
			<div class="col-md-12">
			<div class="row"> 
				<div class="col-sm-4" style="margin-top:1rem">
					<form action="../seling" method="get">
						...
						<input type="submit" class="btn btn-primary btn-wide login-btn" value="确定选课" />
					</form>
				</div>
				<div class="col-sm-4" style="margin-top:1rem">
					<form action="../backseling/${cid }" method="get">
						<input type="submit" class="btn btn-primary btn-wide login-btn" value="取消选课" />
					</form>
				</div>
			</div>
			</div>
